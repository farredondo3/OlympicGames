...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The winner in the volleyball competition is " + Volleyball.winner(player1, player2) + "!");
        System.out.println("The winner in the BasketBall competition is " + Basketball.winner(basketplyr1, basketplyr2) + "!");
